    ...
    return (
        <>
            ...
            <Box className={styles.pricingContainer}>
                ...
                <PricingCard
                    priceValue={50.99}
                    features={["Notifications", "Price history", "Price scraping on demand"]}
                />
                <PricingCard
                    priceValue={99.99}
                    features={["Notifications", "Price history", "Price scraping on demand", "Intelligent price suggestions", "...and more"]}
                />
            </Box>
        </>
    );
